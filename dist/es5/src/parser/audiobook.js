...
function isAudioBookPublication(urlOrPath) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var p, isHttp, url, fileName, ext, audio, audioLcp, audioLcpAlt, manStr, manJson, _1;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    p = urlOrPath;
                    ...
                    if (!(!isHttp && fileName === "manifest.json")) return [3, 5];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4, rnfs.stat(p)];
                case 2:
                    _a.sent();
                    return [4, rnfs.readFile(p, { encoding: "utf8" })];
                case 3:
                    manStr = _a.sent();
